...
const moneyHud = Vue.createApp({
  ...
  methods: {
    ...
    showAccounts(data) {
      ...
      else if (data.type === 'jcoin' && !this.showBank) {
        this.showBank = true;
        this.bank = data.bank;
        setTimeout(() => this.showBank = false, 3500);
      }
...
const playerHud = {
  data() {
    return {
      ...
      showHorseStaminaColor: "#9e9075 ",
      showHorseHealthColor: "#9e9075 ",
      showHorseCleanColor: "#9e9075 ",
  ...
  methods: {
    hudTick(data) {
      ...
      if (parseInt(data.stamina) <= 30) {
        ...
        this.showStaminaColor = "#FFFFFF";
      }
      if (data.hunger <= 30) {
        this.showHungerColor = "#FF0000";
      } else {
        this.showHungerColor = "#FFFFFF";
      }
      if (data.thirst <= 30) {
        this.showThirstColor = "#FF0000";
      } else {
        this.showThirstColor = "#FFFFFF";
      }
      if (data.cleanliness <= 30) {
        this.showCleanlinessColor = "#FF0000";
      } else {
        this.showCleanlinessColor = "#FFFFFF";
      }
      if (data.armor <= 0) {
      ...
      if (data.youhavemail) {
        this.showYouHaveMailColor = "#ffdd00";
      } else {
        this.showYouHaveMailColor = "#ffdd00";
      }
      if (data.pvp) {
